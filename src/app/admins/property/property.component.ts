...
export class PropertyComponent implements OnInit {
  ...
  data:any;
displayedColumns: string[] = ['name', 'images','price','location','status','size','description','dateListed','actions'];
  ...
  constructor(private proservImas:PropertyImageServiceService,
     private service:ProservService, private router:ActivatedRoute,private dialog:MatDialog) { }
  openDialog() {
